...
class ViewImagesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (object2.has("images")) {
            ...
            request_images_recycler.setLayoutManager(mLayoutManager)
            request_images_recycler.addItemDecoration(
            ...
            request_images_recycler.setItemAnimator(DefaultItemAnimator())
            request_images_recycler.setAdapter(adapter)
            ...
            Toast.makeText(
              ...
              "No Images are attached with the request",
                Toast.LENGTH_LONG
            ).show()
        }
    }

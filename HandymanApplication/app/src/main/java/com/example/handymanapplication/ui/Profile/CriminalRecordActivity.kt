...
import kotlinx.android.synthetic.main.activity_criminal_record.*
import java.io.File
import java.io.FileOutputStream
import java.util.*

class CriminalRecordActivity : AppCompatActivity() {
    val RequestCode = 10002
    var file_base64: String? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_criminal_record)
        criminal_record_view.webViewClient = WebViewClient()
        criminal_record_view.settings.setSupportZoom(true)
        criminal_record_view.settings.javaScriptEnabled = true
        val url = getPdfUrl()
        criminal_record_view.loadUrl("https://docs.google.com/gview?embedded=true&url=$url")

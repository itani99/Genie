...
class CertificateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        certificate_view.webViewClient = WebViewClient()
        certificate_view.settings.setSupportZoom(true)
        certificate_view.settings.javaScriptEnabled = true
        val url = getPdfUrl()
        certificate_view.loadUrl("https://docs.google.com/gview?embedded=true&url=$url")
    ...
    fun savePDF(document: String, id: Int) {
        Fuel.post(
            Utils.API_EDIT_PROFILE, listOf("certificate" to document)
        ).header(
